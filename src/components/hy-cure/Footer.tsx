    ...
    <footer className="mt-auto border-t border-slate-200 bg-slate-900 text-slate-200">
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
          <div>
            <p className="text-lg font-bold text-white">한양 케어가이드 (HY Care Guide)</p>
        ...
        <div className="mt-8 border-t border-slate-800 pt-6 text-xs leading-relaxed text-slate-400">
          ...
          <p className="mt-2">
            본 화면은 HY Care Guide 서비스 컨셉을 소개하기 위한 데모 페이지이며, 실제 화면 및 수치와
            다를 수 있습니다.
          </p>
          <p className="mt-4">&copy; 2026 HY Care Guide. All rights reserved.</p>
        </div>
      </div>
